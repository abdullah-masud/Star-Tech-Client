        ...
        <div className='max-w-7xl mx-auto  lg:my-16'>
            <div class="hero  ">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    <img className='lg:w-1/2' src={contact} alt='' data-aos="fade-left" data-aos-duration='700' data-aos-delay='200' />
                    <div className=' w-full flex flex-col' data-aos="fade-right" data-aos-duration='700' data-aos-delay='200'>
